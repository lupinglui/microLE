...
void radio_init(void)
{
	...
	NRF_RADIO->PCNF1 = (
		...
		(((32UL) << RADIO_PCNF1_STATLEN_Pos) & RADIO_PCNF1_STATLEN_Msk) | // Expand the payload with N bytes in addition to LENGTH [0-255]
...
{
	// if not used, only one packet gets send
	...
	//usbLink->sendPacket(TEST, tx_buffer, 255);
